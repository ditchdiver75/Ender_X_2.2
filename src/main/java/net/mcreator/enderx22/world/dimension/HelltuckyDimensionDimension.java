...
package net.mcreator.enderx22.world.dimension;
...
import net.mcreator.enderx22.item.HelltuckyDimensionItem;
import net.mcreator.enderx22.block.PortalBlockBlock;
...
public class HelltuckyDimensionDimension extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:helltuckydimension")
	public static final ModDimension dimension = null;
	@ObjectHolder("enderx22:helltuckydimension_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public HelltuckyDimensionDimension(EnderXModElements instance) {
		super(instance, 168);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("helltuckydimension"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("enderx22:helltuckydimension")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("enderx22:helltuckydimension"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("enderx22:helltuckydimension"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("enderx22:helltucky")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new HelltuckyDimensionItem().setRegistryName("helltuckydimension"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("helltuckydimension_portal");
		}
			...
			for (int k7 = -1; k7 < 3; ++k7) {
				for (int j8 = -1; j8 < 4; ++j8) {
					if (k7 == -1 || k7 == 2 || j8 == -1 || j8 == 3) {
						...
						this.world.setBlockState(blockpos$mutableblockpos, PortalBlockBlock.block.getDefaultState().getBlock().getDefaultState(), 3);
					}
				}
			}
		...
		public ChunkProviderModded(World world, BiomeProvider provider) {
			super(world, provider, new NetherGenSettings() {
				public BlockState getDefaultBlock() {
					return EXNetherackBlock.block.getDefaultState();
				}
