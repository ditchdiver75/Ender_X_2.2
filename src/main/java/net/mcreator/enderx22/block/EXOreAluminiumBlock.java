...
public class EXOreAluminiumBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exorealuminium")
	public static final Block block = null;
	public EXOreAluminiumBlock(EnderXModElements instance) {
		super(instance, 125);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("exorealuminium");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exorealuminium", "exorealuminium", blockAt -> {
