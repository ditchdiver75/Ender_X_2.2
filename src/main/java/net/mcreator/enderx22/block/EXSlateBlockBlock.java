...
public class EXSlateBlockBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exslateblock")
	public static final Block block = null;
	public EXSlateBlockBlock(EnderXModElements instance) {
		super(instance, 164);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exslateblock", "exslateblock", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 7), Placement.COUNT_RANGE, new CountRangeConfig(7, 0, 0, 58)));
		}
	}
}
