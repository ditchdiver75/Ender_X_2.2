...
public class EXNetherEnderBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exnetherender")
	public static final Block block = null;
	public EXNetherEnderBlock(EnderXModElements instance) {
		super(instance, 28);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exnetherender", "exnetherender", blockAt -> {
