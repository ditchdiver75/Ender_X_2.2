...
public class EXBasaltBlockBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exbasaltblock")
	public static final Block block = null;
	public EXBasaltBlockBlock(EnderXModElements instance) {
		super(instance, 162);
	}
