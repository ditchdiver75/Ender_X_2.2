...
public class EXSmoothLimestoneStairsBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exsmoothlimestonestairs")
	public static final Block block = null;
	public EXSmoothLimestoneStairsBlock(EnderXModElements instance) {
		super(instance, 354);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.ROCK).sound(SoundType.STONE)
					.hardnessAndResistance(3f, 14f).lightValue(0).harvestLevel(2).harvestTool(ToolType.PICKAXE));
			setRegistryName("exsmoothlimestonestairs");
		}
