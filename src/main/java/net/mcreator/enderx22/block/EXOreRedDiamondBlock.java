...
import net.mcreator.enderx22.item.EXRedDiamondItem;
...
public class EXOreRedDiamondBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exorereddiamond")
	public static final Block block = null;
	public EXOreRedDiamondBlock(EnderXModElements instance) {
		super(instance, 291);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(20f, 55f).lightValue(0).harvestLevel(5)
					.harvestTool(ToolType.PICKAXE));
			setRegistryName("exorereddiamond");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EXRedDiamondItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exorereddiamond", "exorereddiamond", blockAt -> {
