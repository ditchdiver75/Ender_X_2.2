...
public class EXOreIronBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exoreiron")
	public static final Block block = null;
	public EXOreIronBlock(EnderXModElements instance) {
		super(instance, 9);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exoreiron", "exoreiron", blockAt -> {
