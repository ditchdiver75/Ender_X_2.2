...
public class EXNetherEmeraldBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exnetheremerald")
	public static final Block block = null;
	public EXNetherEmeraldBlock(EnderXModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("exnetheremerald");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exnetheremerald", "exnetheremerald", blockAt -> {
