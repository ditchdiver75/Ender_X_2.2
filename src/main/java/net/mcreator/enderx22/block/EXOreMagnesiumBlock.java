...
public class EXOreMagnesiumBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exoremagnesium")
	public static final Block block = null;
	public EXOreMagnesiumBlock(EnderXModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("exoremagnesium");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exoremagnesium", "exoremagnesium", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 12), Placement.COUNT_RANGE, new CountRangeConfig(8, 0, 0, 64)));
		}
	}
}
