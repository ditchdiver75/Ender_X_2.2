...
public class EXMarbleBrickStairs2Block extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exmarblebrickstairs2")
	public static final Block block = null;
	public EXMarbleBrickStairs2Block(EnderXModElements instance) {
		super(instance, 334);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.ROCK).sound(SoundType.STONE)
					.hardnessAndResistance(5f, 10f).lightValue(0).harvestLevel(2).harvestTool(ToolType.PICKAXE));
			setRegistryName("exmarblebrickstairs2");
		}
