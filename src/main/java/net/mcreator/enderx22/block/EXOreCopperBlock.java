...
public class EXOreCopperBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exorecopper")
	public static final Block block = null;
	public EXOreCopperBlock(EnderXModElements instance) {
		super(instance, 4);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exorecopper", "exorecopper", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 15), Placement.COUNT_RANGE, new CountRangeConfig(8, 0, 0, 64)));
		}
	}
}
