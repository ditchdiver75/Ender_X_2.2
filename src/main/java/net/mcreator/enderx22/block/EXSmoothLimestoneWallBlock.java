...
public class EXSmoothLimestoneWallBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exsmoothlimestonewall")
	public static final Block block = null;
	public EXSmoothLimestoneWallBlock(EnderXModElements instance) {
		super(instance, 355);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3f, 14f).lightValue(0).harvestLevel(2)
					.harvestTool(ToolType.PICKAXE));
			setRegistryName("exsmoothlimestonewall");
		}
