...
public class EXNetherZincBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exnetherzinc")
	public static final Block block = null;
	public EXNetherZincBlock(EnderXModElements instance) {
		super(instance, 42);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exnetherzinc", "exnetherzinc", blockAt -> {
