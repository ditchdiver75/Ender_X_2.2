...
public class EXNetherMolybdeniumBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exnethermolybdenium")
	public static final Block block = null;
	public EXNetherMolybdeniumBlock(EnderXModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("exnethermolybdenium");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exnethermolybdenium", "exnethermolybdenium", blockAt -> {
