...
public class EXLimestoneStairsBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exlimestonestairs")
	public static final Block block = null;
	public EXLimestoneStairsBlock(EnderXModElements instance) {
		super(instance, 326);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.ROCK).sound(SoundType.STONE)
					.hardnessAndResistance(3f, 10f).lightValue(0).harvestLevel(1).harvestTool(ToolType.PICKAXE));
			setRegistryName("exlimestonestairs");
		}
