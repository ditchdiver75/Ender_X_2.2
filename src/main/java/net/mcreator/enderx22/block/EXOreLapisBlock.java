...
public class EXOreLapisBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exorelapis")
	public static final Block block = null;
	public EXOreLapisBlock(EnderXModElements instance) {
		super(instance, 10);
	}
