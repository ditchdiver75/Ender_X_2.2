...
public class EXOreGoldBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exoregold")
	public static final Block block = null;
	public EXOreGoldBlock(EnderXModElements instance) {
		super(instance, 8);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exoregold", "exoregold", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 5), Placement.COUNT_RANGE, new CountRangeConfig(5, 0, 0, 19)));
		}
	}
}
