...
public class EXNetherNickleBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exnethernickle")
	public static final Block block = null;
	public EXNetherNickleBlock(EnderXModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("exnethernickle");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exnethernickle", "exnethernickle", blockAt -> {
