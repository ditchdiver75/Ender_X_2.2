...
public class EXClayBlockBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exclayblock")
	public static final Block block = null;
	public EXClayBlockBlock(EnderXModElements instance) {
		super(instance, 157);
	}
