...
public class EXDirtBlockBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exdirtblock")
	public static final Block block = null;
	public EXDirtBlockBlock(EnderXModElements instance) {
		super(instance, 154);
	}
