...
public class EXOreTinBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exoretin")
	public static final Block block = null;
	public EXOreTinBlock(EnderXModElements instance) {
		super(instance, 149);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exoretin", "exoretin", blockAt -> {
