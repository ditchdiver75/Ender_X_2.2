...
public class EXOreDiamondBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exorediamond")
	public static final Block block = null;
	public EXOreDiamondBlock(EnderXModElements instance) {
		super(instance, 5);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exorediamond", "exorediamond", blockAt -> {
