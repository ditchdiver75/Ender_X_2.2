...
public class EXNetherLeadBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exnetherlead")
	public static final Block block = null;
	public EXNetherLeadBlock(EnderXModElements instance) {
		super(instance, 32);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exnetherlead", "exnetherlead", blockAt -> {
