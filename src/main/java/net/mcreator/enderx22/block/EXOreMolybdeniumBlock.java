...
public class EXOreMolybdeniumBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exoremolybdenium")
	public static final Block block = null;
	public EXOreMolybdeniumBlock(EnderXModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("exoremolybdenium");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exoremolybdenium", "exoremolybdenium", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 14), Placement.COUNT_RANGE, new CountRangeConfig(8, 0, 0, 64)));
		}
	}
}
