...
public class EXOreQuartzBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exorequartz")
	public static final Block block = null;
	public EXOreQuartzBlock(EnderXModElements instance) {
		super(instance, 15);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exorequartz", "exorequartz", blockAt -> {
