...
public class EXOreNickleBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exorenickle")
	public static final Block block = null;
	public EXOreNickleBlock(EnderXModElements instance) {
		super(instance, 14);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exorenickle", "exorenickle", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 13), Placement.COUNT_RANGE, new CountRangeConfig(5, 0, 0, 64)));
		}
	}
}
