...
public class EXOreSlimmyBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exoreslimmy")
	public static final Block block = null;
	public EXOreSlimmyBlock(EnderXModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.SLIME_BALL, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exoreslimmy", "exoreslimmy", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 4), Placement.COUNT_RANGE, new CountRangeConfig(3, 0, 0, 11)));
		}
	}
}
