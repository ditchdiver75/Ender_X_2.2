...
public class EXNetherDiamondBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exnetherdiamond")
	public static final Block block = null;
	public EXNetherDiamondBlock(EnderXModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("exnetherdiamond");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exnetherdiamond", "exnetherdiamond", blockAt -> {
