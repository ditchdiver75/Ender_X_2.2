...
public class EXSandBlockBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exsandblock")
	public static final Block block = null;
	public EXSandBlockBlock(EnderXModElements instance) {
		super(instance, 158);
	}
