...
public class EXSmoothMarbleStairs2Block extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exsmoothmarblestairs2")
	public static final Block block = null;
	public EXSmoothMarbleStairs2Block(EnderXModElements instance) {
		super(instance, 345);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.ROCK).sound(SoundType.STONE)
					.hardnessAndResistance(4f, 10f).lightValue(0).harvestLevel(2).harvestTool(ToolType.PICKAXE));
			setRegistryName("exsmoothmarblestairs2");
		}
