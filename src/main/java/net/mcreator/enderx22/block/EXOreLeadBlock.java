...
public class EXOreLeadBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exorelead")
	public static final Block block = null;
	public EXOreLeadBlock(EnderXModElements instance) {
		super(instance, 11);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exorelead", "exorelead", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 9), Placement.COUNT_RANGE, new CountRangeConfig(7, 0, 0, 64)));
		}
	}
}
