...
import net.mcreator.enderx22.item.EXTaffeiteGemItem;
...
public class EXOreTaaffeiteBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exoretaaffeite")
	public static final Block block = null;
	public EXOreTaaffeiteBlock(EnderXModElements instance) {
		super(instance, 290);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(19f, 55f).lightValue(0).harvestLevel(6)
					.harvestTool(ToolType.PICKAXE));
			setRegistryName("exoretaaffeite");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EXTaffeiteGemItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exoretaaffeite", "exoretaaffeite", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 2), Placement.COUNT_RANGE, new CountRangeConfig(2, 0, 0, 1)));
		}
	}
}
