...
public class EXStoneBrickStairsBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exstonebrickstairs")
	public static final Block block = null;
	public EXStoneBrickStairsBlock(EnderXModElements instance) {
		super(instance, 357);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.ROCK).sound(SoundType.STONE)
					.hardnessAndResistance(3f, 12f).lightValue(0).harvestLevel(2).harvestTool(ToolType.PICKAXE));
			setRegistryName("exstonebrickstairs");
		}
