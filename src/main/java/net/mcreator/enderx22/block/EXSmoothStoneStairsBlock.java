...
public class EXSmoothStoneStairsBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exsmoothstonestairs")
	public static final Block block = null;
	public EXSmoothStoneStairsBlock(EnderXModElements instance) {
		super(instance, 351);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.ROCK).sound(SoundType.STONE)
					.hardnessAndResistance(3f, 15f).lightValue(0).harvestLevel(2).harvestTool(ToolType.PICKAXE));
			setRegistryName("exsmoothstonestairs");
		}
