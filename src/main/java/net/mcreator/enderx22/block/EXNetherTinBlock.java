...
public class EXNetherTinBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exnethertin")
	public static final Block block = null;
	public EXNetherTinBlock(EnderXModElements instance) {
		super(instance, 150);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exnethertin", "exnethertin", blockAt -> {
