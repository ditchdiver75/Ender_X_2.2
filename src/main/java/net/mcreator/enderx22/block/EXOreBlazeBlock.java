...
public class EXOreBlazeBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exoreblaze")
	public static final Block block = null;
	public EXOreBlazeBlock(EnderXModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.BLAZE_POWDER, (int) (3)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exoreblaze", "exoreblaze", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 10), Placement.COUNT_RANGE, new CountRangeConfig(5, 0, 0, 3)));
		}
	}
}
