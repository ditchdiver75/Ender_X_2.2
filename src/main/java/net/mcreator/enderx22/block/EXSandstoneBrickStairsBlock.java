...
public class EXSandstoneBrickStairsBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exsandstonebrickstairs")
	public static final Block block = null;
	public EXSandstoneBrickStairsBlock(EnderXModElements instance) {
		super(instance, 335);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.ROCK).sound(SoundType.STONE)
					.hardnessAndResistance(2f, 10f).lightValue(0).harvestLevel(1).harvestTool(ToolType.PICKAXE));
			setRegistryName("exsandstonebrickstairs");
		}
