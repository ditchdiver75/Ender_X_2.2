...
public class EXNetherAluminiumBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exnetheraluminium")
	public static final Block block = null;
	public EXNetherAluminiumBlock(EnderXModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("exnetheraluminium");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exnetheraluminium", "exnetheraluminium", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == EXNetherackBlock.block.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 16), Placement.COUNT_RANGE, new CountRangeConfig(10, 0, 0, 256)));
		}
	}
}
