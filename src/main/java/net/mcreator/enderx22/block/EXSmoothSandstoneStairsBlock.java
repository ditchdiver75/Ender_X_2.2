...
public class EXSmoothSandstoneStairsBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exsmoothsandstonestairs")
	public static final Block block = null;
	public EXSmoothSandstoneStairsBlock(EnderXModElements instance) {
		super(instance, 348);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.ROCK).sound(SoundType.STONE)
					.hardnessAndResistance(3f, 10f).lightValue(0).harvestLevel(2).harvestTool(ToolType.PICKAXE));
			setRegistryName("exsmoothsandstonestairs");
		}
