...
public class EXNetherSilverBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exnethersilver")
	public static final Block block = null;
	public EXNetherSilverBlock(EnderXModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("exnethersilver");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exnethersilver", "exnethersilver", blockAt -> {
