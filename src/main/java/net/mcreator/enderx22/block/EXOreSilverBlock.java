...
public class EXOreSilverBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exoresilver")
	public static final Block block = null;
	public EXOreSilverBlock(EnderXModElements instance) {
		super(instance, 17);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exoresilver", "exoresilver", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 13), Placement.COUNT_RANGE, new CountRangeConfig(7, 0, 0, 52)));
		}
	}
}
