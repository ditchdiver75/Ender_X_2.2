...
public class EXOreCoalBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exorecoal")
	public static final Block block = null;
	public EXOreCoalBlock(EnderXModElements instance) {
		super(instance, 3);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exorecoal", "exorecoal", blockAt -> {
