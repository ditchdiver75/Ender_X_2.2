...
public class EXOreZincBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exorezinc")
	public static final Block block = null;
	public EXOreZincBlock(EnderXModElements instance) {
		super(instance, 21);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exorezinc", "exorezinc", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 4), Placement.COUNT_RANGE, new CountRangeConfig(5, 0, 0, 64)));
		}
	}
}
