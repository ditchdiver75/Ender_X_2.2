...
public class EXOreRedstoneBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exoreredstone")
	public static final Block block = null;
	public EXOreRedstoneBlock(EnderXModElements instance) {
		super(instance, 16);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exoreredstone", "exoreredstone", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 14), Placement.COUNT_RANGE, new CountRangeConfig(8, 0, 0, 12)));
		}
	}
}
