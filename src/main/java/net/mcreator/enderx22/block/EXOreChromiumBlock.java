...
public class EXOreChromiumBlock extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exorechromium")
	public static final Block block = null;
	public EXOreChromiumBlock(EnderXModElements instance) {
		super(instance, 2);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("exorechromium", "exorechromium", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 12), Placement.COUNT_RANGE, new CountRangeConfig(6, 0, 0, 54)));
		}
	}
}
