...
public class IngotMagnesiumItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:ingotmagnesium")
	public static final Item block = null;
	public IngotMagnesiumItem(EnderXModElements instance) {
		super(instance, 100);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ingotmagnesium");
		}
