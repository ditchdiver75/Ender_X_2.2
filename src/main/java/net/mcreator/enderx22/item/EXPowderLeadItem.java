...
public class EXPowderLeadItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:expowderlead")
	public static final Item block = null;
	public EXPowderLeadItem(EnderXModElements instance) {
		super(instance, 226);
	}
