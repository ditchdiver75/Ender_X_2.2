...
public class EXBackpackBlackItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exbackpackblack")
	public static final Item block = null;
	public EXBackpackBlackItem(EnderXModElements instance) {
		super(instance, 87);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("exbackpackblack");
		}
