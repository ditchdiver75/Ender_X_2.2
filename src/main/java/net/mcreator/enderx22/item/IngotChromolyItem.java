...
public class IngotChromolyItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:ingotchromoly")
	public static final Item block = null;
	public IngotChromolyItem(EnderXModElements instance) {
		super(instance, 94);
	}
