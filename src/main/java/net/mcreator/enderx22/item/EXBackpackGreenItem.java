...
public class EXBackpackGreenItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exbackpackgreen")
	public static final Item block = null;
	public EXBackpackGreenItem(EnderXModElements instance) {
		super(instance, 89);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("exbackpackgreen");
		}
