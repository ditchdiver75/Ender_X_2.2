...
public class EXPlateCopperItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:explatecopper")
	public static final Item block = null;
	public EXPlateCopperItem(EnderXModElements instance) {
		super(instance, 178);
	}
