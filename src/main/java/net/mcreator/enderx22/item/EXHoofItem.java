...
public class EXHoofItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exhoof")
	public static final Item block = null;
	public EXHoofItem(EnderXModElements instance) {
		super(instance, 152);
	}
