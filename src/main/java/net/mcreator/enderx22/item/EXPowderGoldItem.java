...
public class EXPowderGoldItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:expowdergold")
	public static final Item block = null;
	public EXPowderGoldItem(EnderXModElements instance) {
		super(instance, 225);
	}
