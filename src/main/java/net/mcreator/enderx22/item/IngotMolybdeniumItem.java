...
public class IngotMolybdeniumItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:ingotmolybdenium")
	public static final Item block = null;
	public IngotMolybdeniumItem(EnderXModElements instance) {
		super(instance, 101);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ingotmolybdenium");
		}
