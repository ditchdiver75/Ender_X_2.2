...
public class EXPowderCoalItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:expowdercoal")
	public static final Item block = null;
	public EXPowderCoalItem(EnderXModElements instance) {
		super(instance, 220);
	}
