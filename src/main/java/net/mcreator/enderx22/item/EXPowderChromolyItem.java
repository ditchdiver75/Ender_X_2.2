...
public class EXPowderChromolyItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:expowderchromoly")
	public static final Item block = null;
	public EXPowderChromolyItem(EnderXModElements instance) {
		super(instance, 219);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("expowderchromoly");
		}
