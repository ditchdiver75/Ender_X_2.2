...
public class IngotRedstoneAlloyItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:ingotredstonealloy")
	public static final Item block = null;
	public IngotRedstoneAlloyItem(EnderXModElements instance) {
		super(instance, 103);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ingotredstonealloy");
		}
