...
public class EX_Taaffeite_ArmorArmorItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:ex_taaffeite_armorarmorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("enderx22:ex_taaffeite_armorarmorbody")
	public static final Item body = null;
	@ObjectHolder("enderx22:ex_taaffeite_armorarmorlegs")
	public static final Item legs = null;
	@ObjectHolder("enderx22:ex_taaffeite_armorarmorboots")
	public static final Item boots = null;
	public EX_Taaffeite_ArmorArmorItem(EnderXModElements instance) {
		super(instance, 317);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{22, 62, 53, 22}[slot.getIndex()];
			}
			...
			public String getName() {
				return "ex_taaffeite_armorarmor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(EnderXItemsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "enderx22:textures/models/armor/ex_taaffeite_armor_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("ex_taaffeite_armorarmorhelmet"));
