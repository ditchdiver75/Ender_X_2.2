...
public class EXChroiumenderCompacitorItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exchroiumendercompacitor")
	public static final Item block = null;
	public EXChroiumenderCompacitorItem(EnderXModElements instance) {
		super(instance, 53);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("exchroiumendercompacitor");
		}
