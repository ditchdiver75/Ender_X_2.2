...
public class IngotTinItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:ingottin")
	public static final Item block = null;
	public IngotTinItem(EnderXModElements instance) {
		super(instance, 105);
	}
