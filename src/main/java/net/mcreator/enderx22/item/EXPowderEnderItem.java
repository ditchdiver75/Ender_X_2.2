...
public class EXPowderEnderItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:expowderender")
	public static final Item block = null;
	public EXPowderEnderItem(EnderXModElements instance) {
		super(instance, 224);
	}
