...
public class IngotNickleItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:ingotnickle")
	public static final Item block = null;
	public IngotNickleItem(EnderXModElements instance) {
		super(instance, 102);
	}
