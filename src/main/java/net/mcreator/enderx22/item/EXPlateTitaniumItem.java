...
public class EXPlateTitaniumItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:explatetitanium")
	public static final Item block = null;
	public EXPlateTitaniumItem(EnderXModElements instance) {
		super(instance, 234);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("explatetitanium");
		}
