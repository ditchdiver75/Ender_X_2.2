...
public class EXPlateTinItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:explatetin")
	public static final Item block = null;
	public EXPlateTinItem(EnderXModElements instance) {
		super(instance, 189);
	}
