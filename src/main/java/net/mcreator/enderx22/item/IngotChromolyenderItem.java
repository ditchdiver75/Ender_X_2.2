...
public class IngotChromolyenderItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:ingotchromolyender")
	public static final Item block = null;
	public IngotChromolyenderItem(EnderXModElements instance) {
		super(instance, 96);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ingotchromolyender");
		}
