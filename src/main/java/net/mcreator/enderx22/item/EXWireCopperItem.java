...
public class EXWireCopperItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exwirecopper")
	public static final Item block = null;
	public EXWireCopperItem(EnderXModElements instance) {
		super(instance, 172);
	}
