...
public class EXPowderAluminiumItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:expowderaluminium")
	public static final Item block = null;
	public EXPowderAluminiumItem(EnderXModElements instance) {
		super(instance, 217);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("expowderaluminium");
		}
