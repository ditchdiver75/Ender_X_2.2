...
public class IngotGoldItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:ingotgold")
	public static final Item block = null;
	public IngotGoldItem(EnderXModElements instance) {
		super(instance, 98);
	}
