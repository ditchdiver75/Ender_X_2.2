...
public class EXPlateAluminiumItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:explatealuminium")
	public static final Item block = null;
	public EXPlateAluminiumItem(EnderXModElements instance) {
		super(instance, 179);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("explatealuminium");
		}
