...
public class EXWireRedstoneAlloyItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exwireredstonealloy")
	public static final Item block = null;
	public EXWireRedstoneAlloyItem(EnderXModElements instance) {
		super(instance, 174);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("exwireredstonealloy");
		}
