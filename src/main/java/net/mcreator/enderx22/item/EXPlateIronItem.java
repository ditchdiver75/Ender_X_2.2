...
public class EXPlateIronItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:explateiron")
	public static final Item block = null;
	public EXPlateIronItem(EnderXModElements instance) {
		super(instance, 186);
	}
