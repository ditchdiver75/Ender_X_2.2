...
public class IngotZincItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:ingotzinc")
	public static final Item block = null;
	public IngotZincItem(EnderXModElements instance) {
		super(instance, 107);
	}
