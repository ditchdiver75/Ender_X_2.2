...
public class IngotChromiumItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:ingotchromium")
	public static final Item block = null;
	public IngotChromiumItem(EnderXModElements instance) {
		super(instance, 95);
	}
