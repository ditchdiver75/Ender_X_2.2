...
public class EXPowderMolybdeniumItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:expowdermolybdenium")
	public static final Item block = null;
	public EXPowderMolybdeniumItem(EnderXModElements instance) {
		super(instance, 228);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("expowdermolybdenium");
		}
