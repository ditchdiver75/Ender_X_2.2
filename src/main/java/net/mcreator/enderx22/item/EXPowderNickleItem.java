...
public class EXPowderNickleItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:expowdernickle")
	public static final Item block = null;
	public EXPowderNickleItem(EnderXModElements instance) {
		super(instance, 229);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("expowdernickle");
		}
