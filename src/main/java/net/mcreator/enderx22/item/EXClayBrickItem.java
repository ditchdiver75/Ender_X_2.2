...
public class EXClayBrickItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exclaybrick")
	public static final Item block = null;
	public EXClayBrickItem(EnderXModElements instance) {
		super(instance, 59);
	}
