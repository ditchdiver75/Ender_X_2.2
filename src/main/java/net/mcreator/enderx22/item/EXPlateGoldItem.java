...
public class EXPlateGoldItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:explategold")
	public static final Item block = null;
	public EXPlateGoldItem(EnderXModElements instance) {
		super(instance, 184);
	}
