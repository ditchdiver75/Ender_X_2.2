...
public class EXPowderSilverItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:expowdersilver")
	public static final Item block = null;
	public EXPowderSilverItem(EnderXModElements instance) {
		super(instance, 230);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("expowdersilver");
		}
