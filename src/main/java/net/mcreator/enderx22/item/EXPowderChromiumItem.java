...
public class EXPowderChromiumItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:expowderchromium")
	public static final Item block = null;
	public EXPowderChromiumItem(EnderXModElements instance) {
		super(instance, 218);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("expowderchromium");
		}
