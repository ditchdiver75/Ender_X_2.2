...
public class EXCoatedGoldWireItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:excoatedgoldwire")
	public static final Item block = null;
	public EXCoatedGoldWireItem(EnderXModElements instance) {
		super(instance, 176);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("excoatedgoldwire");
		}
