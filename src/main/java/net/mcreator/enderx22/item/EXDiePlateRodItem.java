...
public class EXDiePlateRodItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exdieplaterod")
	public static final Item block = null;
	public EXDiePlateRodItem(EnderXModElements instance) {
		super(instance, 73);
	}
