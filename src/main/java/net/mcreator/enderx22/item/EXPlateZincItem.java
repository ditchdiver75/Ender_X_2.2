...
public class EXPlateZincItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:explatezinc")
	public static final Item block = null;
	public EXPlateZincItem(EnderXModElements instance) {
		super(instance, 191);
	}
