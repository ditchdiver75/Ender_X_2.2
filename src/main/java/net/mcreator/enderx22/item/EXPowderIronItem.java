...
public class EXPowderIronItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:expowderiron")
	public static final Item block = null;
	public EXPowderIronItem(EnderXModElements instance) {
		super(instance, 216);
	}
