...
public class EXPlateChromiumItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:explatechromium")
	public static final Item block = null;
	public EXPlateChromiumItem(EnderXModElements instance) {
		super(instance, 180);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("explatechromium");
		}
