...
public class EXWireGoldItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exwiregold")
	public static final Item block = null;
	public EXWireGoldItem(EnderXModElements instance) {
		super(instance, 173);
	}
