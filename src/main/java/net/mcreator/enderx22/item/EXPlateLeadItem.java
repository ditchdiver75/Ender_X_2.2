...
public class EXPlateLeadItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:explatelead")
	public static final Item block = null;
	public EXPlateLeadItem(EnderXModElements instance) {
		super(instance, 187);
	}
