...
public class EXPowderMagnesiumItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:expowdermagnesium")
	public static final Item block = null;
	public EXPowderMagnesiumItem(EnderXModElements instance) {
		super(instance, 227);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("expowdermagnesium");
		}
