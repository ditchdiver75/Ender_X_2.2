...
public class EXPlateBronzeItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:explatebronze")
	public static final Item block = null;
	public EXPlateBronzeItem(EnderXModElements instance) {
		super(instance, 181);
	}
