...
public class EXBackpackRedItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exbackpackred")
	public static final Item block = null;
	public EXBackpackRedItem(EnderXModElements instance) {
		super(instance, 90);
	}
