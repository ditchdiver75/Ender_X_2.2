...
public class EXPlateRedstoneAlloyItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:explateredstonealloy")
	public static final Item block = null;
	public EXPlateRedstoneAlloyItem(EnderXModElements instance) {
		super(instance, 198);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("explateredstonealloy");
		}
