...
public class EXPowderDiamondItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:expowderdiamond")
	public static final Item block = null;
	public EXPowderDiamondItem(EnderXModElements instance) {
		super(instance, 222);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("expowderdiamond");
		}
