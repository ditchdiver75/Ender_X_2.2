...
public class EXPlateChromiumenderItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:explatechromiumender")
	public static final Item block = null;
	public EXPlateChromiumenderItem(EnderXModElements instance) {
		super(instance, 185);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("explatechromiumender");
		}
