...
public class EXPlateSilverItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:explatesilver")
	public static final Item block = null;
	public EXPlateSilverItem(EnderXModElements instance) {
		super(instance, 190);
	}
