...
public class EXBackpackBlueItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:exbackpackblue")
	public static final Item block = null;
	public EXBackpackBlueItem(EnderXModElements instance) {
		super(instance, 88);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("exbackpackblue");
		}
