...
public class IngotIronItem extends EnderXModElements.ModElement {
	@ObjectHolder("enderx22:ingotiron")
	public static final Item block = null;
	public IngotIronItem(EnderXModElements instance) {
		super(instance, 91);
	}
